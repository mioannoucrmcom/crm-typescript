...
> = z.pipe(
  z.object({
    billed_period: types.optional(
      z.lazy(() => OrderBilledPeriod$inboundSchema),
    ),
    totals: types.optional(z.lazy(() => OrderTotals$inboundSchema)),
...
> = z.pipe(
  z.object({
    ...
    next_billing_at: types.optional(types.number()),
    next_payment_date: types.optional(types.number()),
    subscription: types.optional(z.lazy(() => OrderSubscription$inboundSchema)),
    paused_period: types.optional(
      z.lazy(() => OrderPausedPeriod$inboundSchema),
    ),
...
export const ComCrmEstimateOrderSelfServiceResourceEstimateOrderOrder$inboundSchema:
  ...
  > = z.pipe(
    z.object({
      id: types.optional(types.string()),
      order_estimate: types.optional(
        z.lazy(() => OrderOrderEstimate$inboundSchema),
      ),
      invoice_estimate: types.optional(
        z.lazy(() => OrderInvoiceEstimate$inboundSchema),
      ),
...
export const ComCrmEstimateOrderSelfServiceResourceEstimateOrderResponse$inboundSchema:
  ...
  > = z.pipe(
    z.object({
      id: types.optional(types.string()),
      order_estimate: types.optional(z.lazy(() => OrderEstimate$inboundSchema)),
      invoice_estimate: types.optional(
        z.lazy(() => InvoiceEstimate$inboundSchema),
      ),
      service_delivery_estimate: types.optional(z.array(z.lazy(() =>
        ComCrmEstimateOrderSelfServiceResourceEstimateOrderServiceDeliveryEstimate$inboundSchema
      ))),
      milestone_plan_estimate: types.optional(z.array(z.lazy(() =>
        MilestonePlanEstimate$inboundSchema
      ))),
      invalid_products: types.optional(z.array(z.lazy(() =>
