 ...
 */
export function hostedPagesComCrmHostedPagesSelfServiceResourceGenerateGiftPassPaymentForm(
  client: CrmcomCore,
  security:
...
> {
  ...
  const path = pathToFunc("/self-service/v2/hosted_pages/gift_passes")();
  ...
  const context = {
    ...
    operationID:
      "com.crm.HostedPagesSelfServiceResource_generateGiftPassPaymentForm",
    oAuth2Scopes: null,
