 ...
 * </div>
 */
export function contactRegisterContactSS(
  client: CrmCore,
  request: operations.RegisterContactSSRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.RegisterContactSSResponse,
    | CrmError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.RegisterContactSSRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/self-service/v2/contacts/register")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.RegisterContactSSResponse$inboundSchema),
