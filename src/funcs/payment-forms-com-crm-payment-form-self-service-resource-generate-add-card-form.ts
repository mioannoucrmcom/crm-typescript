 ...
 */
export function paymentFormsComCrmPaymentFormSelfServiceResourceGenerateAddCardForm(
  client: CrmCore,
  security:
...
> {
  ...
  const path = pathToFunc("/self-service/v2/payment_forms/card")();
  ...
  const context = {
    ...
    operationID: "com.crm.PaymentFormSelfServiceResource_generateAddCardForm",
    oAuth2Scopes: null,
