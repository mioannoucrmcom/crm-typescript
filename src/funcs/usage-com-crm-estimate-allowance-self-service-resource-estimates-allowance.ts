 ...
 */
export function usageComCrmEstimateAllowanceSelfServiceResourceEstimatesAllowance(
  client: CrmCore,
  request?:
...
> {
  ...
  const path = pathToFunc("/self-service/v2/estimates/allowance")();
  ...
  const context = {
    ...
    operationID:
      "com.crm.EstimateAllowanceSelfServiceResource_estimatesAllowance",
    oAuth2Scopes: null,
