 ...
 */
export function subscriptionsComCrmSubscriptionSelfServiceResourceChangeService(
  client: CrmcomCore,
  security:
    operations.ComCrmSubscriptionSelfServiceResourceChangeServiceSecurity,
  request: operations.ComCrmSubscriptionSelfServiceResourceChangeServiceRequest,
...
> {
  ...
  const path = pathToFunc("/self-service/v2/services/{id}")(pathParams);
  ...
  const context = {
    ...
    operationID: "com.crm.SubscriptionSelfServiceResource_changeService",
    oAuth2Scopes: null,
