 ...
 */
export function communitiesComCrmContactSelfServiceResourceListContactRelationship(
  client: CrmcomCore,
  request:
...
> {
  ...
  const query = encodeFormQuery({
    ...
    "include_termed_transfers": payload.include_termed_transfers,
  ...
  const context = {
    ...
    operationID: "com.crm.ContactSelfServiceResource_listContactRelationship",
    oAuth2Scopes: null,
