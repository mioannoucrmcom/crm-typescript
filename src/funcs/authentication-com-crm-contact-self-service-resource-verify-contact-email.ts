 ...
 */
export function authenticationComCrmContactSelfServiceResourceVerifyContactEmail(
  client: CrmCore,
  request: operations.ComCrmContactSelfServiceResourceVerifyContactEmailRequest,
...
> {
  ...
  const path = pathToFunc("/self-service/v2/contacts/verify_email")();
  ...
  const context = {
    ...
    operationID: "com.crm.ContactSelfServiceResource_verifyContactEmail",
    oAuth2Scopes: null,
