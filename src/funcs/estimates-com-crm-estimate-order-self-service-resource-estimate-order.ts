 ...
 * </div>
 */
export function estimatesComCrmEstimateOrderSelfServiceResourceEstimateOrder(
  client: CrmCore,
  security:
...
> {
  ...
  const path = pathToFunc("/self-service/v2/estimates/orders")();
  ...
  const context = {
    ...
    operationID: "com.crm.EstimateOrderSelfServiceResource_estimateOrder",
    oAuth2Scopes: null,
