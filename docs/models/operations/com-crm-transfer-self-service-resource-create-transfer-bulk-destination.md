...
```typescript
import { ComCrmTransferSelfServiceResourceCreateTransferBulkDestination } from "crmcom/models/operations";

let value: ComCrmTransferSelfServiceResourceCreateTransferBulkDestination = {
