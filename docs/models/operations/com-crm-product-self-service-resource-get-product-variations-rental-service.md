...
```typescript
import { ComCrmProductSelfServiceResourceGetProductVariationsRentalService } from "crmcom/models/operations";

let value: ComCrmProductSelfServiceResourceGetProductVariationsRentalService = {
