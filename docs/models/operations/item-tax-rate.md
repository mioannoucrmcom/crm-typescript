...
```typescript
import { ItemTaxRate } from "crmcom/models/operations";

let value: ItemTaxRate = {
...
| `taxCode`                                                                                  | [operations.ItemTaxCode](../../models/operations/item-tax-code.md)                         | :heavy_minus_sign:                                                                         | Tax rate code                                                                              | VAT                                                                                        |
