...
```typescript
import { ComCrmDeviceSelfServiceResourceUpdateDeviceCustomField } from "crmcom/models/operations";

let value: ComCrmDeviceSelfServiceResourceUpdateDeviceCustomField = {
  key: "back_office",
  value: "0001-12345",
};
```
