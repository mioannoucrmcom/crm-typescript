...
```typescript
import { ListContactTokensSSContent } from "crmcom/models/operations";

let value: ListContactTokensSSContent = {
...
| `intent`                                                                | [operations.IntentResponse](../../models/operations/intent-response.md) | :heavy_minus_sign:                                                      | The intent for which the token was requested                            |                                                                         |
| `communityId`                                                           | *string*                                                                | :heavy_minus_sign:                                                      | The community for which the token was requested                         |                                                                         |