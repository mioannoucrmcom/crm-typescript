...
```typescript
import { ComCrmPaymentFormSelfServiceResourceGeneratePaymentFormResponse } from "crmcom/models/operations";

let value: ComCrmPaymentFormSelfServiceResourceGeneratePaymentFormResponse = {};
```
