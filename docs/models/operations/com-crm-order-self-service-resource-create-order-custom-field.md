...
```typescript
import { ComCrmOrderSelfServiceResourceCreateOrderCustomField } from "crmcom/models/operations";

let value: ComCrmOrderSelfServiceResourceCreateOrderCustomField = {
  key: "back_office",
  value: "0001-12345",
};
```
