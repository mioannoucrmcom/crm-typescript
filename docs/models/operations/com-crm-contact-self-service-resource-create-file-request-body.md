...
```typescript
import { ComCrmContactSelfServiceResourceCreateFileRequestBody } from "crmcom/models/operations";

let value: ComCrmContactSelfServiceResourceCreateFileRequestBody = {
