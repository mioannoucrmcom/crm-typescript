# RegisterContactSSCountryOfAgreement
...
```typescript
import { RegisterContactSSCountryOfAgreement } from "crmcom/models/operations";

let value: RegisterContactSSCountryOfAgreement = "CYP";
```
