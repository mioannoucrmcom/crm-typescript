...
```typescript
import { ComCrmContactSelfServiceResourceGetCommunitiesItemType } from "crmcom/models/operations";

let value: ComCrmContactSelfServiceResourceGetCommunitiesItemType = "PRODUCT";
```
