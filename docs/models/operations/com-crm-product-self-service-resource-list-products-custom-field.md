...
```typescript
import { ComCrmProductSelfServiceResourceListProductsCustomField } from "crmcom/models/operations";

let value: ComCrmProductSelfServiceResourceListProductsCustomField = {
  key: "back_office",
  value: "0001-12345",
};
```
