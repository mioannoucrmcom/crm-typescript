...
```typescript
import { ComCrmEstimateOrderSelfServiceResourceEstimateOrderChangeToProduct } from "crmcom/models/operations";

let value: ComCrmEstimateOrderSelfServiceResourceEstimateOrderChangeToProduct =
  {
