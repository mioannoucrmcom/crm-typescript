...
```typescript
import { ComCrmEstimateOrderSelfServiceResourceEstimateOrderLineItemDiscount } from "crm/models/operations";

let value: ComCrmEstimateOrderSelfServiceResourceEstimateOrderLineItemDiscount =
  {
    discountAmount: 0.96,
