...
```typescript
import { ComCrmProductSelfServiceResourceListProductsAccessPeriod } from "crmcom/models/operations";

let value: ComCrmProductSelfServiceResourceListProductsAccessPeriod = {
