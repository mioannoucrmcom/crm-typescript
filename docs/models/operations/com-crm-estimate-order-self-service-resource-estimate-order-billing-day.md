...
```typescript
import { ComCrmEstimateOrderSelfServiceResourceEstimateOrderBillingDay } from "crmcom/models/operations";

let value: ComCrmEstimateOrderSelfServiceResourceEstimateOrderBillingDay = {
  dayOfWeek: "MONDAY",
  dayOfMonth: 5,
  monthOfYear: "JANUARY",
};
