...
```typescript
import { InitialContact } from "crmcom/models/operations";

let value: InitialContact = {
...
| `type`                                                                           | [operations.InitialContactType](../../models/operations/initial-contact-type.md) | :heavy_minus_sign:                                                               | Contact type - can be PERSON or COMPANY                                          |                                                                                  |
