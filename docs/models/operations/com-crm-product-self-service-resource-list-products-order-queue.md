...
```typescript
import { ComCrmProductSelfServiceResourceListProductsOrderQueue } from "crmcom/models/operations";

let value: ComCrmProductSelfServiceResourceListProductsOrderQueue = {
