...
```typescript
import { ComCrmWalletSelfServiceResourceGetBalancesCountryCode } from "crmcom/models/operations";

let value: ComCrmWalletSelfServiceResourceGetBalancesCountryCode = "CYP";
```
