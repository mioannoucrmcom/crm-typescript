...
```typescript
import { ComCrmContactSelfServiceResourceAuthenticateCommunity } from "crmcom/models/operations";

let value: ComCrmContactSelfServiceResourceAuthenticateCommunity = {
