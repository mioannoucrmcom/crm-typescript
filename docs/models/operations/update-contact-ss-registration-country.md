# UpdateContactSSRegistrationCountry
...
```typescript
import { UpdateContactSSRegistrationCountry } from "crmcom/models/operations";

let value: UpdateContactSSRegistrationCountry = "CYP";
```
