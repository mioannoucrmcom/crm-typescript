# UpdateContactAddressSSCountryCode
...
```typescript
import { UpdateContactAddressSSCountryCode } from "crmcom/models/operations";

let value: UpdateContactAddressSSCountryCode = "CYP";
```
