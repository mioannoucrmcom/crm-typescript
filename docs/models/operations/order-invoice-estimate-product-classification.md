# OrderInvoiceEstimateProductClassification
...
```typescript
import { OrderInvoiceEstimateProductClassification } from "crmcom/models/operations";

let value: OrderInvoiceEstimateProductClassification =
