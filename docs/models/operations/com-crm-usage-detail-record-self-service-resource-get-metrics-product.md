...
```typescript
import { ComCrmUsageDetailRecordSelfServiceResourceGetMetricsProduct } from "crmcom/models/operations";

let value: ComCrmUsageDetailRecordSelfServiceResourceGetMetricsProduct = {
