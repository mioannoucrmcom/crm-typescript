...
```typescript
import { ComCrmEstimateOrderSelfServiceResourceEstimateOrderService } from "crmcom/models/operations";

let value: ComCrmEstimateOrderSelfServiceResourceEstimateOrderService = {
