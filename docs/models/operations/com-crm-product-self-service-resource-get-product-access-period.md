...
```typescript
import { ComCrmProductSelfServiceResourceGetProductAccessPeriod } from "crmcom/models/operations";

let value: ComCrmProductSelfServiceResourceGetProductAccessPeriod = {
