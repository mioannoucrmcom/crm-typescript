...
```typescript
import { ComCrmContactSelfServiceResourceListContactRelationshipMethod } from "crmcom/models/operations";

let value: ComCrmContactSelfServiceResourceListContactRelationshipMethod =
  "AUTO";
```
