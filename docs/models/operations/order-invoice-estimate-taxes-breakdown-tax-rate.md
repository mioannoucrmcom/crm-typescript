...
| `taxCode`                                                                                                                          | [operations.OrderInvoiceEstimateTaxesBreakdownTaxCode](../../models/operations/order-invoice-estimate-taxes-breakdown-tax-code.md) | :heavy_minus_sign:                                                                                                                 | Tax rate code                                                                                                                      | VAT                                                                                                                                |
