...
```typescript
import { ComCrmOrganisationSelfServiceResourceListCustomField } from "crmcom/models/operations";

let value: ComCrmOrganisationSelfServiceResourceListCustomField = {
  key: "back_office",
  value: "0001-12345",
};
```
