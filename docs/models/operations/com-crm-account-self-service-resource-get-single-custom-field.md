...
```typescript
import { ComCrmAccountSelfServiceResourceGetSingleCustomField } from "crmcom/models/operations";

let value: ComCrmAccountSelfServiceResourceGetSingleCustomField = {
  key: "back_office",
  value: "0001-12345",
};
```
