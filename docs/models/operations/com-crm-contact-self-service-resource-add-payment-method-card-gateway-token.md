...
```typescript
import { ComCrmContactSelfServiceResourceAddPaymentMethodCardGatewayToken } from "crmcom/models/operations";

let value: ComCrmContactSelfServiceResourceAddPaymentMethodCardGatewayToken = {
...
| `gateway`                                                         | [operations.CardGateway](../../models/operations/card-gateway.md) | :heavy_minus_sign:                                                | Defines the gateway that issued such token                        | JCC                                                               |
